...
object RholangContractService {
  ...
  def apply(): RholangContractService = new RholangContractService(grpc)
  def apply(grpc: DeployRholangGrpc): RholangContractService = new RholangContractService(grpc)
}

class RholangContractService(grpc: DeployRholangGrpc) {
